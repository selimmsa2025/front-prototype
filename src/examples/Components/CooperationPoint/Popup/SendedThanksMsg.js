...
export default function SendedThanksMsg({ close }) {
  ...
  const [receivedData, setSendedData] = useState([]);
  const getSendedThanksMsg = async () => {
    const response = await axios.get('/mockupServer/getSendedThanksMsg.json');
    setSendedData(
      _.filter(
    ...
    <>
      <div className='popup active'>
        <article className='size_md '>
          <h2 className='txt_center'>보낸 감사 메시지</h2>
                      ...
                      <div className='item'>
                        ...
                        <div className='bottom_box'>
                          ...
                          <Textarea
                            ...
                            id='textarea1'
                            class='textarea'
                            value={data.receivedMessage || ''}
                          />
                          <div class='clear'>
                            <span class='txt_help'>
                              감사 메세지 수정 후 버튼을 클릭 하세요.
                            </span>
                            <Button
                              as='a'
                              color='2'
